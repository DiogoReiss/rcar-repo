...
export class RentalController {
  ...
  findOne(@Param('id', ParseUUIDPipe) id: string) { return this.rentalService.findOne(id); }
  ...
  openContract(@Param('id', ParseUUIDPipe) id: string, @Body() dto: OpenContractDto) {
  ...
  closeContract(@Param('id', ParseUUIDPipe) id: string, @Body() dto: CloseContractDto) {
  ...
  cancelContract(@Param('id', ParseUUIDPipe) id: string) { return this.rentalService.cancelContract(id); }
