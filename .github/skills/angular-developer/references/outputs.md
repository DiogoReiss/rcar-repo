...
Each TypeScript snippet below is independent. When a snippet declares a component class, prefer `export default class ComponentName`.
...
@Component({...})
export default class LegacyExample {
