...
Prefer `export default` for lazily loaded components. It keeps the loader shorter and avoids the extra `.then(...)` mapping.

If the component file uses a named export instead, map it explicitly:
